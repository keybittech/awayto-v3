...
ENV_LIST="PG_DB PG_WORKER_PASS PG_WORKER USER_SUB GROUP_ID IS_WORKER IS_USER IS_CREATOR HAS_GROUP HAS_TOPIC IS_GROUP_ADMIN IS_GROUP_BOOKINGS IS_GROUP_SCHEDULES IS_GROUP_SERVICES IS_GROUP_SCHEDULE_KEYS IS_GROUP_ROLES IS_GROUP_USERS IS_GROUP_PERMISSIONS"
