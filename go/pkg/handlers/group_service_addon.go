...
func (h *Handlers) PostGroupServiceAddon(w http.ResponseWriter, req *http.Request, data *types.PostGroupServiceAddonRequest, session *types.UserSession, tx interfaces.IDatabaseTx) (*types.PostGroupServiceAddonResponse, error) {
...
func (h *Handlers) GetGroupServiceAddons(w http.ResponseWriter, req *http.Request, data *types.GetGroupServiceAddonsRequest, session *types.UserSession, tx interfaces.IDatabaseTx) (*types.GetGroupServiceAddonsResponse, error) {
...
func (h *Handlers) DeleteGroupServiceAddon(w http.ResponseWriter, req *http.Request, data *types.DeleteGroupServiceAddonRequest, session *types.UserSession, tx interfaces.IDatabaseTx) (*types.DeleteGroupServiceAddonResponse, error) {
	_, err := tx.Exec(`
