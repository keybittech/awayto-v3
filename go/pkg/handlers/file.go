...
func (h *Handlers) PostFileContents(w http.ResponseWriter, req *http.Request, data *types.PostFileContentsRequest, session *types.UserSession, tx *sql.Tx) (*types.PostFileContentsResponse, error) {
...
func (h *Handlers) PatchFileContents(w http.ResponseWriter, req *http.Request, data *types.PatchFileContentsRequest, session *types.UserSession, tx *sql.Tx) (*types.PatchFileContentsResponse, error) {
...
func (h *Handlers) GetFileContents(w http.ResponseWriter, req *http.Request, data *types.GetFileContentsRequest, session *types.UserSession, tx *sql.Tx) (*[]byte, error) {
...
func (h *Handlers) PostFile(w http.ResponseWriter, req *http.Request, data *types.PostFileRequest, session *types.UserSession, tx *sql.Tx) (*types.PostFileResponse, error) {
	file := data.GetFile()
	var fileID string
	err := tx.QueryRow(`
...
func (h *Handlers) PatchFile(w http.ResponseWriter, req *http.Request, data *types.PatchFileRequest, session *types.UserSession, tx *sql.Tx) (*types.PatchFileResponse, error) {
	_, err := tx.Exec(`
...
func (h *Handlers) GetFiles(w http.ResponseWriter, req *http.Request, data *types.GetFilesRequest, session *types.UserSession, tx *sql.Tx) (*types.GetFilesResponse, error) {
	var files []*types.IFile
	err := h.Database.QueryRows(tx, &files, "SELECT * FROM dbview_schema.enabled_files")
	if err != nil {
		return nil, util.ErrCheck(err)
	}
...
func (h *Handlers) GetFileById(w http.ResponseWriter, req *http.Request, data *types.GetFileByIdRequest, session *types.UserSession, tx *sql.Tx) (*types.GetFileByIdResponse, error) {
	var files []*types.IFile
	err := h.Database.QueryRows(tx, &files, "SELECT * FROM dbview_schema.enabled_files WHERE id = $1", data.GetId())
...
func (h *Handlers) DeleteFile(w http.ResponseWriter, req *http.Request, data *types.DeleteFileRequest, session *types.UserSession, tx *sql.Tx) (*types.DeleteFileResponse, error) {
...
func (h *Handlers) DisableFile(w http.ResponseWriter, req *http.Request, data *types.DisableFileRequest, session *types.UserSession, tx *sql.Tx) (*types.DisableFileResponse, error) {
	_, err := tx.Exec(`
		UPDATE dbtable_schema.files
