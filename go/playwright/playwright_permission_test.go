...
func testPlaywrightPermission(t *testing.T) {
	t.Run("admin can update user roles", func(tt *testing.T) {
		...
		page.ById("manage_role_actions_staff_app_group_schedules").MouseOver().Click()
		page.ById("manage_role_actions_staff_app_group_bookings").MouseOver().Click()

		// Student can request appointments
		page.ById("manage_role_actions_member_app_group_bookings").MouseOver().Click()
